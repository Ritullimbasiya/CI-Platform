...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAPTOP-059GJ899;Database=Cl-Platform;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Banner>(entity =>
            {
                ...
                entity.Property(e => e.DaletedAt)
                    .HasColumnType("datetime")
                    .HasColumnName("daleted_at");
            ...
            {
                entity.HasKey(e => e.CmPageId);

                entity.ToTable("cms_page");

                entity.Property(e => e.CmPageId).HasColumnName("cm_page_id");
            ...
            {
                entity.HasKey(e => e.FavouriteMisssionId);

                entity.ToTable("favourite_mission");

                entity.Property(e => e.FavouriteMisssionId).HasColumnName("favourite_misssion_id");
            ...
            modelBuilder.Entity<MissionRating>(entity =>
            {
                ...
                entity.Property(e => e.MisssionId).HasColumnName("misssion_id");
                ...
                entity.HasOne(d => d.Misssion)
                    .WithMany(p => p.MissionRatings)
                    .HasForeignKey(d => d.MisssionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
